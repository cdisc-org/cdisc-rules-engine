...
def test_variable_count(target, expected, mock_data_service, operation_params: OperationParams, dataset_type):
    ...
    datasets_map = {
        ...
        "AEXX": dataset_type.from_dict({"STUDYID": [4, 7, 9], "AESEQ": [1, 2, 3], "DOMAIN": [12, 6, 1]}),
    ...
    result = VariableCount(operation_params, datasets_map["AE"], cache, mock_data_service).execute()
