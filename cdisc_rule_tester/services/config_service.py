...
class ConfigService:
    ...
    def __new__(cls):
        if cls._instance is None:
            ...
            for key in cls._config:
                if cls._config[key] == None:
                    # import within function, loading it outside of function at parent scope will cause a circular dependency
    ...
    def getValue(self,key,default=None):
        if key in ConfigService._config and ConfigService._config[key] != None:
