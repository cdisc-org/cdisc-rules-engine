...
def test_is_valid_whodrug_reference(sdtm_standards_context, domain, target, data, result):
    ...
    op_result = PostgresQLOperators(config).is_valid_whodrug_reference({"target": target})
