...
def cached(cache_key: str):
    ...
    """
    def format_cache_key(key: str, study_id=None, data_bundle_id=None, domain_name=None):
        """
    ...
    def decorator(func: Callable):
        ...
        def inner(*args, **kwargs):
            instance = args[0]
            data_bundle_id = instance.data_bundle_id if hasattr(instance, "data_bundle_id") else kwargs.get("data_bundle_id")
            study_id = instance.study_id if hasattr(instance, "study_id") else kwargs.get("study_id")
            domain_name = instance.domain_name if hasattr(instance, "domain_name") else kwargs.get("domain_name")
