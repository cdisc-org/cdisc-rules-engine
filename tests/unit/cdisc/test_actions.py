...
def test_nan_handling_in_error_object():
    ...
    assert '"NAN_VAL": null' in json_output, "Missing null value for NAN_VAL in JSON output"
    assert "[4.0, null, 6.0]" in json_output, "Missing list with individual null element [4.0, null, 6.0]"
    assert "[7.0, 8.0, null]" in json_output, "Missing list with individual null element [7.0, 8.0, null]"
