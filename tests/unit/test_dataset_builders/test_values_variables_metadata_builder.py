    ...
    ae1_data = pd.DataFrame(
        {
            ...
            "variable_value": ["STUDY1", "Headache"],
        }
    )
        ...
        return_value=pd.DataFrame.from_dict(
            {
                ...
                "variable_order_number": [1, 9],
                "variable_data_type": ["text", "text"],
                "variable_format": ["$16.", "$200."],
            }
        )
    )
    ...
    expected_data = pd.DataFrame(
        {
            ...
            "source_row_number": [1, 2, 3, 4, 1, 2, 3, 4],
        }
    )
