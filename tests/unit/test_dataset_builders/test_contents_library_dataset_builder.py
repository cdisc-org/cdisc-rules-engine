...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            {
                "library_variable_name": ["VAR1", "VAR3"],
                "library_variable_label": ["VAR1 Label", "VAR3 Label"],
                "library_variable_role": ["VAR1 ROLE", "VAR3 ROLE"],
...
@patch(
    ...
    + "BaseDatasetBuilder.get_library_variables_metadata"
)
@patch(
    "cdisc_rules_engine.services.data_services.LocalDataService.get_dataset",
)
def test_contents_library_variables_dataset_builder(
    ...
    mock_get_library_variables_metadata.return_value = dataset_implementation.from_dict(
        variables_metadata
    )

    result = ContentsLibraryVariablesDatasetBuilder(
        rule=None,
