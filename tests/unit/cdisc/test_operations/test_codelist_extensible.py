...
def test_missing_codelist(operation_params):
    ...
    with raises(MissingDataError, match="Codelist 'CL_NONEXISTENT' not found in metadata"):
...
def test_multiple_versions(operation_params, mock_metadata, package_type, codelist_code, expected):
    ...
    evaluation_dataset = PandasDataset.from_dict({"version": versions, "codelist_code": ["C1", "C2", "C3"]})
