...
class TestCLI(unittest.TestCase):
    ...
    def test_validate_required_s_option_missing(self):
        result = self.runner.invoke(
            validate, ["-v", "3.4", "-dp", os.path.join("tests", "resources", "test_dataset.xpt")]
        )
    ...
    def test_validate_required_s_option_present(self):
        result = self.runner.invoke(
            validate,
            ["-s", "sdtmig", "-v", "3.4", "-dp", os.path.join("tests", "resources", "test_dataset.xpt")],
        )
        print(result.output)
    ...
    def test_validate_required_v_option_missing(self):
        result = self.runner.invoke(
            validate, ["-s", "sdtmig", "-dp", os.path.join("tests", "resources", "test_dataset.xpt")]
        )
        self.assertEqual(result.exit_code, 2)
