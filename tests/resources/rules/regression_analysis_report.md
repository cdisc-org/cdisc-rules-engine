...
## Missing Operations (10 operations, 82 total failures across 13 rule occurrences)
...
## Execution Errors by Type (15 unique error types, 144 total failures across 32 rule occurrences)

1.  **An unknown exception has occurred**: 85 failures across 15 rules
