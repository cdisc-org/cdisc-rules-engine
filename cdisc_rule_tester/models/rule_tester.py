...
class RuleTester:
    ...
    def __init__(self, datasets):
        ...
        self.data_service = DummyDataService.get_instance(cache, ConfigService(), data=self.datasets)
    ...
    def validate(self, rule) -> dict:
        ...
        dataset_dictionaries = [{"domain": domain.domain, "filename": domain.filename} for domain in self.datasets]
