...
class SQLDataProcessor:
    ...
    #     """
    #     parent_dataset = SQLDataProcessor.filter_parent_dataset_by_supp_dataset_rdomain(parent_dataset, supp_dataset)
    #     return SQLDataProcessor.filter_dataset_by_nested_columns_of_other_dataset(
    ...
    #         decimal_group_values: pd.Series = SQLDataProcessor.convert_float_merge_keys(group[column_with_values])
    #         decimal_dataset_values: pd.Series = SQLDataProcessor.convert_float_merge_keys(dataset[group.name])
    ...
    #     SQLDataProcessor.cast_numeric_cols_to_same_data_type(
    ...
    #         pass
    #     return (
    #         df.from_dict(df[SQLDataProcessor.convert_float_merge_keys(df[col]) == str(filter_value)].to_dict())
    #         if filter_value
    #         else df
    #     )
    ...
    #     left_subset = SQLDataProcessor.filter_if_present(left_subset, "USUBJID", relrec_row["USUBJID"])
    #     right_subset = SQLDataProcessor.filter_if_present(right_subset, "USUBJID", relrec_row["USUBJID"])
    #     if relrec_row["IDVARVAL_LEFT"] and relrec_row["IDVARVAL_RIGHT"]:
    #         left_subset = SQLDataProcessor.filter_if_present(
    #             left_subset, relrec_row["IDVAR_LEFT"], relrec_row["IDVARVAL_LEFT"]
    #         )
    #         right_subset = SQLDataProcessor.filter_if_present(
    ...
    #         4. Union the results
    #     """
    #     relrec_for_domain = SQLDataProcessor.filter_relrec_for_domain(left_dataset_domain_name, relrec_dataset)

    #     # TODO: FIX
    #     objs = [
    #       SQLDataProcessor.merge_on_relrec_record(relrec_row, left_dataset, datasets, dataset_preprocessor, wildcard)
    ...
    # ) -> DatasetInterface:
    #     result = SQLDataProcessor.filter_dataset_by_match_keys_of_other_dataset(
    #         left_dataset,
    #         left_dataset_match_keys,
    #         right_dataset,
    #         right_dataset_match_keys,
    #     )
    #     result = SQLDataProcessor.filter_parent_dataset_by_supp_dataset(
    #         result,
    #         right_dataset,
    ...
    #     result = SQLDataProcessor.merge_datasets_on_relationship_columns(
    #         left_dataset=result,
    ...
    #     right_dataset = SQLDataProcessor.process_supp(right_dataset)
    ...
    #     left_is_numeric: bool = SQLDataProcessor.column_contains_numeric(left_dataset[left_dataset_column])
    #     right_is_numeric: bool = SQLDataProcessor.column_contains_numeric(right_dataset[right_dataset_column])
    #     if left_is_numeric and right_is_numeric:
    #         # convert to float
    #         right_dataset[right_dataset_column] = right_dataset[right_dataset_column].astype(float)
    #         left_dataset[left_dataset_column] = left_dataset[left_dataset_column].astype(float)
    ...
    #         if SQLDataProcessor.column_metadata_equal_to_define_and_library(
