...
class RuleTypes(BaseEnum):
    DATASET_CONTENTS_CHECK_AGAINST_DEFINE_AND_LIBRARY = "Dataset Contents Check against Define XML and Library Metadata"
    ...
    VARIABLE_METADATA_CHECK_AGAINST_LIBRARY = "Variable Metadata Check against Library Metadata"
    ...
    DEFINE_ITEM_METADATA_CHECK_AGAINST_LIBRARY = "Define Item Metadata Check against Library Metadata"
